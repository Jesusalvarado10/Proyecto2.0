...
/**
 * The Bedroom class represents a bedroom. It contains information about the
 * type, floor, occupancy status, and a tree representing the bedroom's history.
 *
 * The class provides methods to access and modify the bedroom's properties,
 * such as the type, floor, occupancy status, and the associated tree.
 *
 * @author Daniel
 */
