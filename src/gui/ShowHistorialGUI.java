 ...
 * @author Daniel
 */
public class ShowHistorialGUI extends javax.swing.JFrame {
    ...
    private void update(){
        ...
        phone.setText("PRIVADO");
        ride.setText("PRIVADO");
        departure.setText("PRIVADO");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ShowHistorialGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new ShowHistorialGUI(client).setVisible(true);
        });
    }
    // </editor-fold>
